// https://github.com/teloxide/teloxide/blob/c14439ecdef18c41101ba2ca785edf4164a36a28/crates/teloxide-core/src/types/unit_true.rs
...
impl Visitor<'_> for TrueVisitor {
        ...
        E: de::Error,
    {
        if value {
            ...
            Err(E::custom("expected `true`, found `false`"))
        }
    }
}
